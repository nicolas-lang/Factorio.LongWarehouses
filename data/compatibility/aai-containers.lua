...
if mods["aai-containers"] then
	--
	whTech = data.raw["technology"]["nco-LongWarehouses"]
	...
	--
	whTechLogistic1 = data.raw["technology"]["nco-LongWarehousesLogistics1"]
	...
	--
	whTechLogistic2 = data.raw["technology"]["nco-LongWarehousesLogistics2"]
